    ...
    <div class="wrap">
        <div class="fifter">
            <el-row>
                ...
                <el-col :span="7">
                    <el-input class="search" placeholder="按企业名称搜索" prefix-icon="el-icon-search" v-model="searchval"></el-input>
                </el-col>
                <el-col :span="7">
        ...
        <div class="table">
            <template>
                <el-table :data="tableData" border style="width: 100%">
                    <el-table-column prop="entName" label="企业名称" width="110"></el-table-column>
                    <el-table-column prop="uscc" label="单位证件号" width="130"></el-table-column>
                    <el-table-column prop="bankName" label="开户银行"></el-table-column>
                    <el-table-column prop="bkNo" label="银行账号"></el-table-column>
        ...
        <el-dialog title="企业认证详细" :visible.sync="dialogdetail" width="70%">
            <el-form>
                <el-row :gutter="gutter">
                    <el-col :span="12">
                        <el-form-item label="企业名称" label-width="70px">
                            <el-input v-model="userinfo.enterpriseName" autocomplete="off" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="证件号" label-width="70px">
                            <el-input v-model="userinfo.uscc" autocomplete="off" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="gutter">
                    <el-col :span="12">
                        <el-form-item label="开户银行" label-width="70px">
                            <el-input v-model="userinfo.bankName" autocomplete="off" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="银行账号" label-width="70px">
                            <el-input v-model="userinfo.bkNo" autocomplete="off" disabled></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="gutter">
    ...
    methods: {
        creatrequest() {
            ...
            this.$request({
                ...
                url: "/permission/selectAllEnterprisePermission"
            })
            .then(res => {
                console.log(res);
                if (res.data.code == 0) {
        ...
        selectfifter(){
            ...
            if(!this.searchval){
                delete this.requestdata.entName;
            }
